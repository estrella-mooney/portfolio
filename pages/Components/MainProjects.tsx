                ...
                <div className="w-full lg:w-5/12 mt-10 lg:mt-0 lg:pl-5 relative z-10 md:pr-0 lg:pr-10">
                  <div className="flex flex-col items-start justify-start">
                    ...
                    <p className="mb-3 tracking-wide">
                      As our final project for the Dev Academy Bootcamp, our
                      team of six developed a React app. It was created to
                      assist newcomers in Wellington, New Zealand in connecting
                      with locals for guidance and cultural immersion. React,
              ...
              <div className=" flex flex-col lg:flex-row items-start justify-between max-w-7xl mx-auto px-5 xl:px-0">
                ...
                <div className="w-full lg:w-5/12 mt-10 lg:mt-0 lg:pl-5 relative z-10 md:pr-0 lg:pr-10">
                  <div className="flex flex-col items-start justify-start">
                    ...
                    <p className="mb-3 tracking-wide">
                      {' '}
                      WanderLust is a web app for kiwis to keep a record of
                      their bucket list hikes. I was inspired to develop
                      wanderLust to solve my own struggles of having my favorite
                      hiking locations scattered across numerous documents. The
                      mvp of WanderLust was built using React, React-Redux,
                      Express and SQLite3. But one of the key features that I
                      plan to add in the future is Auth0, for users to access
                      and view their own saved hikes. This will also allow users
                      to upload photos and screenshots of their favorite
                      locations, making it an all-in-one solution for organizing
                      their hiking goals and experiences.
                    </p>
              ...
              <div className="flex flex-col lg:flex-row items-start justify-between max-w-7xl mx-auto px-5 xl:px-0">
                ...
                <div className="w-full lg:w-5/12 mt-10 lg:mt-0 lg:pl-5 relative z-10 md:pr-0 lg:pr-10">
                  <div className="flex flex-col items-start justify-start">
                    ...
                    <p className="mb-3 tracking-wide">
                      Discover what the future holds with Wisdom of Zoltash -
                      your ultimate fortune-telling app. Wisdom of Zoltash
                      showcased my group and I&apos;s first two weeks of
                      bootcamp learning. This project was the very first group
                      project we worked on at Dev Academy, where we had one week
                      to learn how to use Handlebar templates and Express.js.
                      While we successfully completed the project using
                      Handlebars, we transitioned to learning React the
                      following week. Now, I would like to take this project to
